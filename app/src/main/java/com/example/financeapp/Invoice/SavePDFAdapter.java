...
import com.example.financeapp.Invoice.data.utils.PriceUtils;
    ...
    public void onBindViewHolder(SavePDFHolder holder, int position) {
        if(mCursor.moveToPosition(position)){
            ...
            if (position == getItemCount()-1){
                com.example.financeapp.Invoice.SavePDFActivity.printTotalDetails(totalQty, totalTaxableValue, totalSingleGst, totalAmount);
            }
