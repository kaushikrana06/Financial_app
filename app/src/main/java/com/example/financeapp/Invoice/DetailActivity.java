...
import com.example.financeapp.Invoice.data.utils.NumberToWord;
...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private com.example.financeapp.Invoice.DetailAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new com.example.financeapp.Invoice.DetailAdapter(this);
...
//            Intent pdfIntent = new Intent(this, com.example.financeapp.Invoice.SavePDFActivity.class);
