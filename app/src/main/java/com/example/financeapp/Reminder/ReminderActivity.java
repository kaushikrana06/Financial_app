...
public class ReminderActivity extends AppCompatActivity {
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intent = new Intent(getApplicationContext(), com.example.financeapp.Reminder.AlarmBrodcast.class);
        ...
        Intent intentBack = new Intent(getApplicationContext(), com.example.financeapp.Reminder.RemindActivity.class);                //this intent will be called once the setting alaram is completes
